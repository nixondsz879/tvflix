...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211106_tvflix_de6ea2e97f9077202257_20211106090840_archive.zip';
	const ARCHIVE_SIZE		 = '64300560';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'de6ea2e-06090840';
    const SECONDARY_PACKAGE_HASH = '2cc91b1-06090840';
	const VERSION			 = '1.4.3';
