...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211106_tvflix_f1a40ce7f26c01304609_20211106085806_archive.zip';
	const ARCHIVE_SIZE		 = '98180814';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f1a40ce-06085806';
    const SECONDARY_PACKAGE_HASH = 'c5aa41c-06085806';
	const VERSION			 = '1.4.3';
